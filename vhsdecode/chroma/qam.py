"""Burst measurement, track phase rotation detection, and the
heterodyne up-conversion pipeline used by the QAM colour-under
formats (PAL/NTSC/PAL-M) and by ME-SECAM.
"""
